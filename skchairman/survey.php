...
<body class="d-flex align-items-center justify-content-center min-vh-100">
    ...
    <div class="container survey-container">
        <div class="row g-0 bg-white rounded-3 shadow-lg overflow-hidden">
            <div class="col-md-6 p-4 p-md-5">
                ...
                <form id="surveyForm">
                    <div class="mb-3">
                        <label for="youthName" class="form-label">Youth Name</label>
                        <input type="text" class="form-control" id="youthName" required>
                    </div>
                    <div class="mb-3">
    ...
    <script>
        document.getElementById('surveyForm').addEventListener('submit', function(e) {
            ...
            const surveyUrl = `https://example.com/survey?name=${encodeURIComponent(youthName)}`;
