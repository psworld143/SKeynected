    ...
    <main>
        <div class="container">
            ...
            <section class="section error-403 min-vh-100 d-flex flex-column align-items-center justify-content-center">
                <h1 class="text-white mt-5">404</h1>
                <h2 class="text-white">The page you are looking for doesn't exist..</h2>
                <a class="btn" href="index.php">Back to home</a>
                <img src="assets/img/output-onlinegiftools.gif" class="img-fluid" alt="Access Forbidden" width="400px">
            </section>
